...
**Generated:** 2026-09-04 09:30 UTC
...
|---:|---|---|---:|---|---:|---:|---:|---|
| 1 | `google/gemini-2.5-flash` | paid | 70.60 | Pass | 0/26 | 47.1 | 0.0174 | — |
| 2 | `qwen/qwen3.7-flash` | paid | 62.11 | **DQ** | 0/26 | 115.7 | 0.0031 | yes |
| 3 | `deepseek/deepseek-chat` | paid | 60.84 | **DQ** | 0/26 | 324.0 | 0.0038 | yes |
| 4 | `openai/gpt-4.1-nano` | paid | 60.27 | **DQ** | 0/26 | 80.8 | 0.0047 | yes |
| 5 | `nvidia/nemotron-3.5-lightning:free` | free | 59.80 | **DQ** | 0/26 | 399.1 | 0.0000 | yes |
| 6 | `upstage/solar-pro4` | paid | 53.78 | **DQ** | 0/26 | 149.7 | 0.0030 | yes |
| 7 | `nvidia/nemotron-3-super-120b-a12b:free` | free | 52.32 | **DQ** | 1/26 | 114.0 | 0.0000 | yes |
| 8 | `gemma3:27b` | local | 50.80 | **DQ** | 0/26 | 323.9 | 0.0000 | yes |
| 9 | `qwen3:32b` | local | 49.60 | **DQ** | 0/26 | 272.6 | 0.0000 | yes |
| 10 | `llama3.1:8b` | local | 44.06 | **DQ** | 0/26 | 1808.9 | 0.0000 | yes |
| 11 | `minimax/minimax-m2.7:free` | free | 60.22 | **INVALID** | 26/26 | 3.6 | 0.0000 | yes |
| 12 | `google/gemma-4-31b-it:free` | free | 55.03 | **INVALID** | 25/26 | 950.9 | 0.0000 | yes |
| 13 | `z-ai/glm-5.2:free` | free | 48.22 | **INVALID** | 20/26 | 1437.0 | 0.0000 | yes |
...
|---|---:|---:|---:|---:|---:|---:|
| `google/gemini-2.5-flash` | 42.9 | 75.1 | 67.7 | 92.0 | 100.0 | 100.0 |
| `qwen/qwen3.7-flash` | 42.9 | 44.8 | 65.6 | 100.0 | 100.0 | 96.9 |
| `deepseek/deepseek-chat` | 42.9 | 64.3 | 70.4 | 60.0 | 100.0 | 55.2 |
| `openai/gpt-4.1-nano` | 42.9 | 48.5 | 65.0 | 80.0 | 100.0 | 100.0 |
...
- `deepseek/deepseek-chat`: hallucinated_recommendation_rate=0.38>0.25
- `openai/gpt-4.1-nano`: hallucinated_recommendation_rate=0.86>0.25
- `qwen/qwen3.7-flash`: hallucinated_recommendation_rate=0.76>0.25
- `upstage/solar-pro4`: hallucinated_recommendation_rate=0.86>0.25
...
- `nvidia/nemotron-3.5-lightning:free`: hallucinated_recommendation_rate=0.71>0.25
- `nvidia/nemotron-3-super-120b-a12b:free`: hallucinated_recommendation_rate=0.62>0.25; format_compliance=0.24<0.50
- `gemma3:27b`: hallucinated_recommendation_rate=0.86>0.25
- `llama3.1:8b`: hallucinated_recommendation_rate=0.81>0.25
- `qwen3:32b`: hallucinated_recommendation_rate=0.86>0.25; format_compliance=0.48<0.50
